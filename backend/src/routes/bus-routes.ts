...
//
// The learned files live under data/bus-routes/learned/, which is also Vite's
// publicDir in dev — the frontend fetches the JSON straight from Vite there.
// The backend serves the same files so production needs no extra static host,
// and serves the index in both cases (Vite can't list a directory).
